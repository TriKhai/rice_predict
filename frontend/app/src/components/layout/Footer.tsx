...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-100 dark:bg-[#030712] dark:text-gray-400 text-center text-sm text-gray-600 py-4 mt-10 border-t border-t-gray-50 dark:border-t-gray-600">
